...
-- Q1-2. ORDER BY - DESC) products에서 product_name을 price 내림차순으로 출력하기
SELECT product_name
FROM products
ORDER BY price DESC;

-- Q1-3. ORDER BY - 정렬 조건 나열) products에서 product_name을 price 내림차순 및 product_id 오름차순으로 출력하기
SELECT product_name
FROM products
ORDER BY price DESC, product_id;

-- Q1-4. ORDER BY - 정렬 조건 번호 대체) products에서 product_name / price / product_id를 price 내림차순 및 product_id 오름차순으로 출력하기
