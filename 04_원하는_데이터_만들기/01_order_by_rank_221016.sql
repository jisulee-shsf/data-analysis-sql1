-- Q1-1. ORDER BY - products에서 product_name을 price 오름차순으로 출력하기
SELECT product_name
FROM products
ORDER BY price;

-- Q1-2. ORDER BY - products에서 product_name을 price 내림차순으로 출력하기
SELECT product_name
FROM products
ORDER BY price DESC;

-- Q1-3. ORDER BY - products에서 product_name을 price 내림차순 후, product_id 오름차순으로 출력하기
SELECT product_name
FROM products
